...
<div id="loader">
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.html"><img src="images/hmslogo.PNG" alt="" style="height: 70px;"></a> </div>
      <div class="head-info">
        <ul>
          ...
          <li> <i class="fa fa-envelope-o"></i>
            <p>toptimehsp@gmail.com<br>
              info@toptimehsp.com</p>
          </li>
